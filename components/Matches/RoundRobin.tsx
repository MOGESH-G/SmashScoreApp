...
const RoundRobin = ({ data, updateMatchData, simpleMode }: RoundRobinType) => {
            ...
            {Object.entries(matches).map(([round, matchesInRound]) => (
              ...
              >
                <View style={{ height: 70 }} className=" bg-primary justify-center items-center">
                  <Text className="text-lg font-bold text-white text-center">SET {round}</Text>
                </View>
                <ScrollView className="p-3 gap-8">
